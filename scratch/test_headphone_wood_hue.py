...
def test_headphone_wood_hue_mask():
    ...
    for f in frames:
        ...
        # Mark dark pixels (headphones) as probable foreground (GC_PR_FGD) or definite foreground (GC_FGD)
        ...
        out_path = f"scratch/test_headphone_wood_hue_{f}"
        cv2.imwrite(out_path, segmented)
        print(f"Saved {out_path}")

if __name__ == "__main__":
    test_headphone_wood_hue_mask()
