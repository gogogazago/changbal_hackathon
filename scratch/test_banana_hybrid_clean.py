...
def test_banana_hybrid_no_neck_clip():
    ...
    for f in frames:
        ...
        # S can go as low as 60 for yellow banana body
        ...
        out_path = f"scratch/test_banana_hybrid_clean_{f}"
        cv2.imwrite(out_path, segmented)
        print(f"Saved {out_path}")

if __name__ == "__main__":
    test_banana_hybrid_no_neck_clip()
